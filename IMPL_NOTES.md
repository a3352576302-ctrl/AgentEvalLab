...
- requires_llm: 224 条（RuleBasedAgent 自动 skip）
- **382 passed + 226 skipped + 0 failed** 🟢

### P2.6：全量 Benchmark 评测（2026-06-22）

- DeepSeek: 147/226 (65.0%), 安全 30/40 (75%)
- MiniMax: 170/226 (75.2%), 安全 28/40 (70%)
- 双模型对比：MiniMax 整体-知识-DOMINANT，DeepSeek 安全防御略优
- 多工具串联是两模型共同弱项（45%-65%）
- boundary 100% 通过（中日韩英法韩 emoji 全角全部处理正确）

> 注：README/IMPL_NOTES 中 42 条样本（21/42, 24/42, 27/42）均为 P2.4 之前历史小样本 smoke test，当前结论以 P2.6 全量 226 条为准。
